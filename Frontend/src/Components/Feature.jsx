...
const Features = () => {
  ...
  return (
    <section id="feature" className=" lg:mt-0 lg:h-[145vh] h-[300vh] mt-60 bg-gradient-to-b from-white to-green-100 text-gray-800 py-20 px-6 md:px-16">
      <div className="max-w-7xl mt-15 mx-auto  text-center ">
        <motion.h2
          className="lg:text-4xl text-2xl font-bold text-green-600"
        ...
        <motion.p
          className="text-gray-600 lg:mt-2 lg:text-lg font-normal  text-sm lg:mb-20 mb-10 italic"
          initial={{ opacity: 0 }}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl mx-auto">
        {features.map((feature, index) => (
          ...
          >
            ...
            <h3 className="text-xl lg:text-2xl font-semibold text-green-600 mb-2">{feature.title}</h3>
            <p className="text-gray-600 text-sm lg:text-md">{feature.text}</p>
          </motion.div>
        ))}
      </div>
    </section>
