...
import { FaInstagram, FaTwitter, FaLinkedin, FaYoutube, FaCommentDots } from "react-icons/fa";
...
const Footer = ({ setlogin }) => {
  ...
  return (
    <>
      ...
      {/* --- Floating Elements (Placed outside footer to escape overflow-hidden and backdrop-blur containing block) --- */}
      ...
      <AnimatePresence>
        {openFAQ && (
          <FAQSection setOpenFAQ={setOpenFAQ} />
        )}
      </AnimatePresence>
